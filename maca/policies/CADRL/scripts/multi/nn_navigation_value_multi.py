...
from maca.policies.CADRL.scripts.neural_networks import neural_network_regr_multi as nn
...
from maca.policies.CADRL.scripts.multi import global_var as gb, gen_rand_testcases as gen_tc, pedData_processing_multi as pedData
...
class NN_navigation_value:
    ...
    def find_next_action(self, agent_state, other_agents_state, other_agents_action=None, static_constraints=None):
        ...
        state_values = self.find_next_states_values(agent_state, actions_theta, other_agents_state, other_agents_action)
    ...
    # check collision 
    def if_actions_collide(self, agent_state, agent_actions, other_agent_state, other_agent_action, delta_t):
        # bnd
    ...
    def find_states_values(self, agent_states, other_agents_state):
        ...
        if agent_states.ndim == 1:
            ref_prll, ref_orth, state_nn = pedData.rawState_2_agentCentricState(agent_states, other_agents_state, self.num_agents)
            ...
            pedData.rawStates_2_agentCentricStates(agent_states, other_agents_state, self.num_agents)
