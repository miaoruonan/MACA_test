...
from maca.policies.GA3C_CADRL import network
...
class GA3CCADRLPolicy(InternalPolicy):
    ...
    def find_next_action(self, obs, agents, i):
        """ Using only the dictionary obs, convert this to the vector needed for the GA3C-CADRL network,
        query the network, adjust the actions for this env.
