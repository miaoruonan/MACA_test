...
from maca.policies import InternalPolicy


try:
    import torch
    import torch.nn as nn
    from maca.policies.DRL_Long.model.ppo import generate_action_no_sampling
    from maca.policies.DRL_Long.model import MLPPolicy, CNNPolicy
except:
...
class DRLLongPolicy(InternalPolicy):
    """ Wrapper for an implementation of
    `Towards Optimally Decentralized Multi-Robot Collision Avoidance via Deep Reinforcement Learning <https://arxiv.org/abs/1709.10082>`_.
