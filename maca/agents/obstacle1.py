...
class Obstacle(BaseAgent):
    ...
    """
    def __init__(self, start_x, start_y,  radius, id):
        ...
        self.sensors = [sensor() for sensor in [OtherAgentsStatesSensor]]
        self.dynamics_model = FullDynamics(self)
        self.pref_speed = 0.0
        ...
        self.reset(px=start_x, py=start_y, gx=start_x , gy=start_y ,  pref_speed=self.pref_speed, radius=radius, heading=self.initial_heading)
