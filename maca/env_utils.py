...
from maca.envs.wrappers import FlattenDictWrapper, MultiagentFlattenDictWrapper, MultiagentDummyVecEnv, MultiagentDictToMultiagentArrayWrapper
...
def create_env():
    ...
    def make_env():
        ...
        if Config.TRAIN_SINGLE_AGENT:
            ...
            env = MultiagentDictToMultiagentArrayWrapper(env,
...
policy_dict = {
    ...
    'GA3C-CADRL': {
        'policy': 'GA3C_CADRL',
        'checkpt_dir': "run-cadrl_rand-20210219",
        'checkpt_name': 'network_01490001', # network_01490000 network_00250000
        'sensors': ['other_agents_states'],
         },
