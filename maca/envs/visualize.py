import numpy as np
from maca.envs.util import find_nearest, rgba2rgb
...
def draw_agents(agents, circles_along_traj, ax, last_index=-1):
    ...
    for i, agent in enumerate(agents):
        ...
        if circles_along_traj:
            ...
            text_spacing = 1.0
            text_times =   np.arange(0.0, agent.global_state_history[agent.step_num+last_index, 0], text_spacing)
            _, text_inds = find_nearest(agent.global_state_history[:agent.step_num, 0], text_times)
