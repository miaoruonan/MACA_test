import numpy as np
from maca.envs.sensors.Sensor import Sensor
from maca.envs import Config
from maca.envs.util import compute_time_to_impact, vec2_l2_norm
import operator
...
class OtherAgentsStatesSensor(Sensor):
    ...
    def get_clipped_sorted_inds(self, sorting_criteria):
        ...
        Args:
            sorting_criteria (str): how to sort the list of agents (one of ['closest_last', 'closest_first', 'time_to_impact']).
            See journal paper.
