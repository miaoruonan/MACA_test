...
from maca.configs.config import Config as EnvConfig
...
class TrainPhase(Train):
    def __init__(self):
        self.MAX_NUM_AGENTS_IN_ENVIRONMENT = 4
        self.MAX_NUM_AGENTS_TO_SIM = 4
        Train.__init__(self)
        self.TRAIN_VERSION = self.ONLY_TRAIN_RL
...
class TrainPhase1(Train):
    def __init__(self):
        ...
        self.EPISODE_NUMBER_TO_LOAD   = 1490001 # 01490001

        self.LOAD_FROM_WANDB_RUN_ID   = 'run-20210102'
        self.SPECIAL_EPISODES_TO_SAVE = [1990000, 2000000]

class TrainPhase10(Train):
    def __init__(self):
        self.MAX_NUM_AGENTS_IN_ENVIRONMENT = 4
        self.MAX_NUM_AGENTS_TO_SIM = 4
        Train.__init__(self)
...
class TrainPhase2(Train):
    def __init__(self):
        ...
        self.LOAD_FROM_WANDB_RUN_ID = 'run-2018-backup'
        # self.EPISODE_NUMBER_TO_LOAD        = 1490000
        self.EPISODE_NUMBER_TO_LOAD        = 3885000
        self.SPECIAL_EPISODES_TO_SAVE = [1990000, 2000000]
