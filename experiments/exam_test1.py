...
for i in range(agent_num):
    agent = MyDict({
        'id' : i,
        'start_x': start_x + start_x_offset[i],
        'start_y': start_y + start_y_offset[i],
        'goal_x': goal_x + goal_x_offset[i],
        'goal_y': goal_y + goal_y_offset[i],
